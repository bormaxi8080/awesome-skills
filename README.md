...
> Большая часть материалов касается работы на ОС стека Linux и MacOS, поскольку автору они ближе, чем остальные.
...
Книги и мануалы в формате PDF по некоторым технологиям для удобства выложены в отдельный репозиторий:
...
> 
> TODO: 12 книг по Go (разобрать!): https://techrocks.ru/2019/10/29/12-books-for-golang-learning/
> 
> TODO: еще 30 книг ))) https://proglib.io/p/30-golang-books
...
### Learn React.js - Полное руководство:
...
> 
> Гид по Metasploit Framework от SecurityLab:
> 
